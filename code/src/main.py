...
def process_video(video_path, output_video=None):
    references = {"left": (20, 100), "right": (320, 400), "door": (60, 120)}
    count_passed = 0
    count_enter = 0
    ...
    print("HAN ENTRADO A LA TIENDA: " + str(tracker_inst.get_counter_enter()))
    print("HAN PASADO DE LARGO: " + str(tracker_inst.get_counter_pass()))

if __name__ == '__main__':
    args = parse_parameters()
    process_video("/videos/5_OneLeaveShopReenter1front.mpg", args.output_video_path)